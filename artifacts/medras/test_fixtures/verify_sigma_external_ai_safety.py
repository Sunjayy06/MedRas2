...
def verify_bridge_no_consent_and_provenance() -> None:
    ...
    try:
        ...
        assert result["source"] == "openrouter"
        assert result["provider_status"] == "openrouter"
    finally:
